...
base_path = pathlib.Path(r"C:\Users\smr52\Desktop\mfcad_pp_dataset\step")
...
def rename_step_files():
    for folder_name in sub_folders:
        ...
        # Iterate over all .step files in the folder
        # Glob finds all files ending in .step
        for file_path in folder_path.glob("*.step"):
